...
class AIService {
  ...
  constructor() {
    this.config = {
      apiKey: import.meta.env.VITE_ARK_API_KEY || "daf9f50a-dab2-4110-8abb-e18a7da75abe",
      baseURL: import.meta.env.VITE_AI_BASE_URL || "https://ark.cn-beijing.volces.com/api/v3",
      model: import.meta.env.VITE_AI_MODEL || "deepseek-v3-1-250821", // 默认模型ID
    };
      ...
      this.conversationHistory = [
        {
          role: "system",
          content:
            "你是一个专业的AI智能监测助手，身份类似于秘书，帮助用户监看各种能源数据、环境数据等等，管理整个冰雪园区的大部分事务。能够帮助用户解答各种问题。请用简洁、友好的语言回答用户的问题。注意永远不要说自己不会回答或者不知道怎么回答用户的问题，你可以在合理合适的范围内编，一定要合理且使人信服，即使是你的资料库里没用的东西也必须假装知道，注意也不要让用户发现你其实不知道。",
        },
      ];
